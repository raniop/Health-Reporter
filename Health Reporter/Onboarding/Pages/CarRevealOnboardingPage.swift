...
final class CarRevealOnboardingPage: UIViewController {
    ...
    init(delegate: OnboardingPageDelegate, carName: String, carEmoji: String, healthScore: Int) {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            coverView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 80),
            ...
            carNameLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 16),
            ...
            scoreContainer.topAnchor.constraint(equalTo: carNameLabel.bottomAnchor, constant: 24),
            ...
            descriptionLabel.topAnchor.constraint(equalTo: scoreContainer.bottomAnchor, constant: 24),
